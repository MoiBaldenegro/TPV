import { Body, ConflictException, Controller, Get, NotFoundException, Param, Post, Delete, HttpCode, Put } from '@nestjs/common';
...
export class DiscountsController {
    ...
    async create(@Body() body : CreateDiscountDto){
        try {
            ...
            if(error.code === 11000){
                throw new ConflictException("Este descuento ya se aplico anteriormente")
            }
    ...
    async delete(@Param("id") id : string ){
        try {
            ...
            if(!deletedDiscount){
                throw new NotFoundException("No se encontro el descuento que intenta eliminar")
            }
    ...
    async update(@Param("id") id : string, body : UpdateDiscountDto){
        try {
            ...
            if(!updatedDiscount){
                throw new NotFoundException("No se encuentra el descuento que se desea actualizar")
            }
